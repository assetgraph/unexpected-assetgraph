  ...
  installInto(expect) {
    ...
    function toAst(stringOrAssetOrFunctionOrAst) {
      if (typeof stringOrAssetOrFunctionOrAst === 'string') {
        return require('assetgraph/lib/parseJavaScript')(
          stringOrAssetOrFunctionOrAst
        );
        ...
        return {
          type: 'Program',
          body: require('assetgraph/lib/parseJavaScript')(
            `!${stringOrAssetOrFunctionOrAst.toString()}`
